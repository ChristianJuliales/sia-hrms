// Philippine Payroll Computation Functions
const PayrollCalculator = {
  calculateSSS: (basicSalary) => {
    const maxMSC = 35000;
    const msc = Math.min(basicSalary, maxMSC);
    return msc * 0.05;
  },
  ...
  calculatePagIBIG: (basicSalary) => {
    return basicSalary > 5000 ? 200 : basicSalary * 0.02;
  },
  ...
  calculateWithholdingTax: (annualIncome) => {
    ...
    if (monthlyIncome <= 20833.33) return 0;
    if (monthlyIncome <= 33333.33) return (monthlyIncome - 20833.33) * 0.05;
    if (monthlyIncome <= 66666.67) return 625 + (monthlyIncome - 33333.33) * 0.10;
    if (monthlyIncome <= 166666.67) return 3958.33 + (monthlyIncome - 66666.67) * 0.15;
    if (monthlyIncome <= 666666.67) return 18958.33 + (monthlyIncome - 166666.67) * 0.20;
    return 118958.33 + (monthlyIncome - 666666.67) * 0.25;
  },
  ...
  calculateOTPay: (basicSalary, hours) => {
    const daily = basicSalary / 22;
    const hourly = daily / 8;
    return hours * (hourly * 1.25);
  }
};
